...
public class JMagicWorldGenerator extends FabricDynamicRegistryProvider {
    public JMagicWorldGenerator(FabricDataOutput output, CompletableFuture<RegistryWrapper.WrapperLookup> registriesFuture) {
